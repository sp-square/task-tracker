...
var selectTaskNameEl = document.querySelector("input[name='task-name']");
var selectTaskTypeEl = document.querySelector("select[name='task-type']");
...
function taskFormHandler(event) {
  ...
  // Retrieve value from input and select elements
  var taskName = selectTaskNameEl.value.trim();
  var taskType = selectTaskTypeEl.value;
  ...
  // Reset form fields and increment taskIdTracker
  selectTaskNameEl.value = '';
  selectTaskTypeEl.selectedIndex = 0;
}
...
function startEditTaskInfo(taskId) {
  ...
  selectTaskNameEl.value = selectedTaskName;
  selectTaskTypeEl.value = selectedTaskType;
